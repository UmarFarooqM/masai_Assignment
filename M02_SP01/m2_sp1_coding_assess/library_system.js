function updateLibrary(library,newSection){ // defining a function upatelibrary with two parameter (library, newsection)
    library.sections={...library.sections,...newSection} // new section is added to library. section using spread operator
    return library
}
const library = {
